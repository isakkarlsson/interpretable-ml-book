...
Linear models have been used for a long time by statisticians, computer scientists, and other people tackling quantitative problems.
...
Estimates of coefficients or weights also comes with confidence intervals.
...
The table shows for each feature the estimated weight and the standard error of the estimation:
...
Judging by the attributes that constitute a good explanation as presented in [Section 3.5.2](#good-explanation), linear models don't create the best explanations.
